...
test("package metadata exposes Node 22 release-check scripts", () => {
  ...
  assert.equal(
    ...
    "node --test test/package/package-install.test.mjs test/package/release-check.test.mjs test/package/release-policy.test.mjs test/package/release-governance.test.mjs test/package/architecture-inventory.test.mjs",
  );
