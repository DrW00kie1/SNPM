...
function baseManifest() {
  return {
    manifestPath: "C:\\tall-man-training\\snpm.sync.json",
    manifestDir: "C:\\tall-man-training",
    ...
    entries: [{
      ...
      absoluteFilePath: "C:\\tall-man-training\\ops\\validation-sessions\\iphone-testflight-0.5.1-2-sean-2026-03-28.md",
    }],
  };
}
  ...
  const manifest = {
    ...
    entries: [
      baseManifest().entries[0],
      {
        ...
        absoluteFilePath: "C:\\tall-man-training\\ops\\validation-sessions\\android-smoke-0.5.1-2-sean-2026-03-28.md",
      },
    ],
  };
  ...
  const manifest = {
    ...
    entries: [
      baseManifest().entries[0],
      {
        ...
        absoluteFilePath: "C:\\tall-man-training\\ops\\validation-sessions\\missing.md",
      },
      {
        kind: "validation-session",
        title: "Legacy Session",
        file: "ops/validation-sessions/legacy.md",
        absoluteFilePath: "C:\\tall-man-training\\ops\\validation-sessions\\legacy.md",
      },
    ],
  };
